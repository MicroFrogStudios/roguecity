...
class Button:
    ...
    def __init__(self,x,y,title :str,width=7,height=3,fg =color.button_color,text_color = color.button_text,bg = color.black,hover=color.button_hover, decoration="╔═╗║ ║╚═╝", on_click = None) -> None:
        self.x = x
        self.y = y
        self.width = width
        self.height = height
